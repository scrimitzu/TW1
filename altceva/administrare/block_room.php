...
if(isset($_POST['block'])){
	...
	$sql = mysql_query("INSERT INTO nelo_rezervari (booking_id, booking_time, start_date, end_date, client_id, is_block, payment_success, block_name) values(".$bookingId.", NOW(), '".$_SESSION['sv_mcheckindate']."', '".$_SESSION['sv_mcheckoutdate']."', '0', 0, 1, '".mysql_real_escape_string($_POST['block_name'])."')");	
