...
<div class="container_stg"><!-- Container Stanga -->
  ...
  <form id="formElem" name="formElem" action="cauta-rezervare.php" method="post">
   <table cellpadding="0"  cellspacing="7" border="0"  align="left" style="text-align:left;">
    ...
    <ul class="gallery">
	      <h3 style="margin:0px auto; margin-left:89px; margin-bottom:13px;">Camera Single&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Camera Double&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Camera Matrimoniala</h3>
			<li><a href="imagini/camera_1.jpg" rel="prettyPhoto[gallery1]" title="Camera Single" class="fade"><img src="imagini/camera_1.jpg" width="300" height="141" alt="Camera Single" /></a></li>
		 
			<li><a href="imagini/camera_2.jpg" rel="prettyPhoto[gallery1]" title="Camera Double" class="fade"><img src="imagini/camera_2.jpg" width="300" height="141" alt="Camera Double" /></a></li>
            <li><a href="imagini/camera_3.jpg" rel="prettyPhoto[gallery1]" title="Camera Matrimoniala" class="fade"><img src="imagini/camera_3.jpg" width="300" height="141" alt="Camera Matrimoniala" /></a></li>
	</ul>
