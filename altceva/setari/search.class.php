	...
	public function getAvailableRooms($roomTypeId, $roomTypeName, $capcityid){
		...
		SELECT rm.room_ID, rm.room_no
		 ...
		 WHERE rm.roomtype_id = ".$roomTypeId."
			   ...
			   AND rm.roomtype_id NOT IN (SELECT n.room_type_id FROM `nelo_rezervari` r,`nelo_rezervari_site` n WHERE n.bookings_id = r.booking_id And r.status = 1 group by n.room_type_id)";
